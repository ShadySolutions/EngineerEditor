...
namespace ICSharpCode.TextEditor
{
	...
	public abstract class TextEditorControlBase : UserControl
	{
		...
		protected TextEditorControlBase()
		{
            ...
            this.BackColor = ThemeHardcode.TextAreaBack;
		}
        ...
        public void SetHighlight(string ScriptName)
        {
            document.HighlightingStrategy = HighlightingStrategyFactory.CreateHighlightingStrategyForFile(ScriptName);
        }
